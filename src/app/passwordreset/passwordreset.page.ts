...
@Component({
  ...
  standalone: true,
  imports: [IonButtons, IonCardHeader, IonCardTitle, IonCardContent, IonInput, IonCardSubtitle, IonItem, IonImg, IonButton, IonBackButton, IonCard, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
